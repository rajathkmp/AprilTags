...
#ifndef ____Laser_h__
#define ____Laser_h__
...
class Laser : virtual public ::IceDelegate::RoboCompLaser::Laser,
...
public:
    ...
    virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
    {
        ...
        if(response)
        {
            (::IceInternal::CallbackNC<T>::callback.get()->*response)(__ret, bState);
        }
    }
...
public:
    ...
    virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
    {
        ...
        if(response)
        {
            (::IceInternal::Callback<T, CT>::callback.get()->*response)(__ret, bState, CT::dynamicCast(__result->getCookie()));
        }
    }
